...
public class CamundaTestMultiInstanceContext implements ExtensionContext.Store.CloseableResource {
  ...
  public CamundaTestMultiInstanceContext() {
  ...
  public GenericContainer<?> getIdentityContainer() {
